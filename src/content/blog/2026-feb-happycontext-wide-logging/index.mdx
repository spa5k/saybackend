...
import DemoFlow from "./demo-flow.svg";
import DemoIntegrations from "./demo-integrations.svg";
import DemoLogStream from "./demo-log-stream.svg";
import DemoSampling from "./demo-sampling.svg";
import OgImage from "./og-image.svg";

<img
  src={OgImage.src}
  alt="happycontext banner with logger and integration highlights"
  loading="eager"
/>
...
<img
  src={DemoLogStream.src}
  alt="Transformation from fragmented log lines to one structured request event"
  loading="lazy"
/>
...
<img
  src={DemoIntegrations.src}
  alt="Router integrations feeding happycontext and logger adapters"
  loading="lazy"
/>
...
<img
  src={DemoFlow.src}
  alt="Request lifecycle from start to enrich to finalize to write"
  loading="lazy"
/>
...
<img
  src={DemoSampling.src}
  alt="Sampler chain showing keep and drop decisions"
  loading="lazy"
/>
