...
import PerformanceBarChart from "@/components/react/charts/PerformanceBarChart.tsx";
import PerformanceScatterChart from "@/components/react/charts/PerformanceScatterChart.tsx";
import RadarChart from "@/components/react/charts/RadarChart.tsx";
import ComparisonChart from "@/components/react/charts/ComparisonChart.tsx";
...
<Callout type="success">
  **Performance Note:** PostgreSQL 18's native uuidv7() delivers 34,127 UUIDs per second
  with guaranteed time ordering - making it the optimal choice for new applications.
  Custom implementations remain excellent for existing PostgreSQL installations.
</Callout>
