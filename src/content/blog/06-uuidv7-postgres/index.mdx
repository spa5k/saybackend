...
import comprehensiveComparison from "./assets/comprehensive_id_comparison.png";
import speedComparison from "./assets/speed_comparison.png";
import implementationArchitecture from "./assets/implementation_architecture.png";
...
<Picture
  src={speedComparison}
  alt="Speed comparison between UUIDv4, UUIDv7, ULID, and TypeID implementations"
/>
...
<Picture
  src={comprehensiveComparison}
  alt="Comprehensive comparison dashboard showing performance, storage, and feature matrices"
/>
...
<Picture
  src={implementationArchitecture}
  alt="Implementation architecture showing the structure and characteristics of each ID type"
/>
