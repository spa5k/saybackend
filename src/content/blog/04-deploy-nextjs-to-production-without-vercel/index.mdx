...
<Callout type="info">
  We are using docker image node:24-slim, because it's based on Debian, and the
...
<Callout type="info">
  While these limitations exist, self-hosting gives you more control over your infrastructure and can be more cost-effective for certain use cases. You can also implement many of these features yourself using third-party services or custom solutions.
</Callout>
