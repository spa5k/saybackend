(() => {
  ...
  var S = (n, e) => {
    for (var t in e) Es(n, t, { get: e[t], enumerable: !0 });
  };
  function j() {}
  function _t(n) {
    return n();
  ...
  var An = (n) => n.toLocaleUpperCase();
  function zs(n, e, t) {
    let { show_images: s = !0 } = e,
      { process_result: l = null } = e,
  ...
  var Vi = "Amber Song",
    ...
    Yi = { thanks_to: Vi, comments: Gi, direction: Ki, strings: Ji };
  var Zi = [
      Rt,
      bt,
      Tt,
  ...
  var nt = class {
    ...
    triggerFilters(e) {
      ...
      for (let [s, l] of Object.entries(e))
        if (Array.isArray(l)) for (let r of l) t[`${s}:${r}`] = !0;
        else t[`${s}:${l}`] = !0;
