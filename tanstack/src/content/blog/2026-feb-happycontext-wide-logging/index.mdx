...
import BlueIntegrations from "./blue-integrations.svg?url";
import BlueSampling from "./blue-sampling.svg?url";
import BlueWideEvents from "./blue-wide-events.svg?url";
...
<WideEventBuilderSimulator client:load />
...
<GitHubRepoCard
  ...
  description="Wide logging for Go: one canonical event per request, with router + logger adapters."
/>
